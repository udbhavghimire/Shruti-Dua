...
$mail->Host = 'mail.shrutidua.com'; // Specify main and backup SMTP servers
$mail->SMTPAuth = true; // Enable SMTP authentication
$mail->Username = 'info@shrutidua.com'; // SMTP username
$mail->Password = 'mail@shrutidua'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587; // TCP port to connect to

$mail->setFrom('info@shrutidua.com', $_POST['name']);
$mail->addAddress('ghimireudbhav@gmail.com');

$mail->addReplyTo($_POST['email']);
$mail->isHTML(true);

$mail->Subject = "Shruti Dua - Landing Page Inquiry";
$message = '<html>
